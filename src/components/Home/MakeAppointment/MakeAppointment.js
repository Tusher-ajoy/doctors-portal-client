            ...
            <div className='container'>
                <div className='row'>
                    ...
                    <div className='col-md-7 text-white mt-5'>
                        ...
                        <button type="button" className="btn btn-primary mt-4" style={{background:'linear-gradient(100deg, #18D3B2 0%, #10CFEB 100%)',borderColor:'#1CC7C1', padding:'10px 50px'}} >Learn More</button>
                    </div>
                </div>
            </div>
        </section>
