        ...
        <div className='container'>
            <main className='row my-5 d-flex align-items-center'>
                <div className='col-md-6'>
                    ...
                    <button type="button" className="btn btn-primary" style={{background:'linear-gradient(100deg, #18D3B2 0%, #10CFEB 100%)',borderColor:'#1CC7C1', padding:'10px 15px'}} >GET APPOINTMENT</button>
                </div>
                <div className='col-md-6'>
